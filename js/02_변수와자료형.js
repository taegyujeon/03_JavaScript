...
console.log(1234);
console.log("문자열을 양쪽에 쌍따옴표를 작성해야 한다!")
...
//변수명 중복 오류 발생!
//let number3 =500; 'number3'을(를) 다시 선언 할 수 없습니다.
...
/* typeof 연산자 : 변수/값의 자료형을 출려하는 연산자 */
...
const gender = 'M'; //한 글자만 작성해도 문자열(sreing)
...
console.log("isFasle: ", isFasle, typeof isFasle);

/* object (객체) */
// (쉬운 버전 설명) 값을 여러 개 저장할 수 있는 상태
